...
<div class="contents-wrap reference active">
                        ...
                        <div class="contents-wrap reference-write">
                        	  <div class="items">
								...
								<form id="insertForm" action="/board/insertBoard.do" method="post"  enctype="multipart/form-data" acceptcharset="UTF-8">
									...
									<input name="category" id="insert_category" value="3" type="hidden">
                        ...
                        <div class="contents-wrap reference-modify">
                        	  <div class="items">
	                            <div class="itemsWrap">
								...
								<form id="modifyForm" action="/board/insertBoard.do" method="post"  enctype="multipart/form-data" acceptcharset="UTF-8">
									...
									<div class="form-group">
	                                    <label for="reference_title" class="control-label">글 제목</label>
	                                    <input class="input form-control" type="text" name="title" id="modify_title" placeholder="글 제목"/>
	                                </div>
									<div class="form-group">
	                                    <label for="reference_content" class="control-label">글 내용</label>                       
	                                    <textarea rows="10" cols="30" id="modify_content" name="content" style="width:100%; height:350px; "></textarea>
	                                </div>
	                                <div class="form-group">
	                                    <label for="reference_attach" class="control-label">파일첨부</label>
	                                    <input type="file" name="file" id="reference_file" class="form-control">
	                                </div>
	                                <div class="form-btn">
	                                    <a href="#" class="cancle">취소</a>
	...
	//목록 버튼
		 $(".listBtn").click(function(){
			...
			$(".contents-wrap.reference").addClass("active")
			pageMove(1);
		}) 
	...
	//목록 버튼 끝
		...
		$(".writeBtn").click(function(){
			//여기에 ajax 구축
			$(".contents-wrap").removeClass("active")
			$(".contents-wrap.reference-write").addClass("active")
			callForm("insert")
		      //저장버튼 클릭시 form 전송
		...
		function pageMove(pageNo){
    	  ...
    	  $.ajax({
		 		...
		 		data : "category=3&pageNo="+pageNo+"&type="+$("#searchType").val()+"&content="+searchWord
		 	}).done(function(data){
		 		//console.log(data)
		 		var html;
				...
				$(".pagination li a").click(function(e){
			 	...
			 	$(".table.list> tbody > tr > td > a").click(function(e){
			 		...
			 		$(".contents-wrap").removeClass("active")
					$(".contents-wrap.reference-detail").addClass("active")
			 	})
    	...
    	function modifyBoard(no){
    		...
    		$.ajax({
    			...
    			$(".contents-wrap").removeClass("active")
    			$(".contents-wrap.reference-modify").addClass("active")
