...
<head>
	...
	<link rel="manifest" href="/assa/resources/img/favicon/manifest.json">
...
<body>
    ...
    <video autoplay muted loop id="myVideo">
        <source src="<c:url value="/resources/media/video3.mp4"/>" type="video/mp4">
      </video>
  ...
  <div class="modal-dialog ">
    <div class="modal-content">
      <div class="modal-body signup">
      	<img src="<c:url value="/resources/img/logo.jpg"/>" class="img-responsive center-block" style="max-width: 200px;"/>
