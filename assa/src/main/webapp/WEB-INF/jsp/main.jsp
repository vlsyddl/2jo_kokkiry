	                        ...
	                        <div class="items">
	                            <div class="itemsWrap">
	                                <div class="latest cf">
	                                    ...
	                                    <div class="latest01">
	                                        <ul>
	                                            <li><a href="#"><span class="type study">스터디</span> ${lastStudy.title}</a></li>
	                                            <li><a href="#"><span class="type daily">일상</span> ${lastDaily.title}</a></li>
	                                            <li><a href="#"><span class="type gallery">사진첩</span> ${lastData.title}</a></li>
