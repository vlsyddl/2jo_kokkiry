  ...
  <div class="modal-dialog">
    <div class="modal-content">
      <div class="modal-body">
      	<img src="<c:url value="/img/logo.jpg"/>" class="img-responsive center-block" style="max-width: 200px;"/>
        <form action="POST" method="post" id="findPassForm">
        	<div class="form-group">
			    <label for="signUp_id" class="col-sm-3 control-label">이름</label>
			    <div class="col-sm-9">
			      <input class="input form-control" type="text" name="id" id="signUp_id" placeholder="  이름"/>
		       ...
		       <div class="form-group">
			    <label for="signUp_email" class="col-sm-3 control-label"></label>
			    <div class="col-sm-9">
      ...
      <div class="modal-footer">
        <button type="button" class="btn btn-danger" data-dismiss="modal">취소</button>
        <button type="button" class="btn btn-success" id="findPassword">비밀번호 찾기</button>
      </div>
    </div>
  </div>
</div>
    ...
    <script>
    	...
    	$(".loginBtn").click(function () {
        	alert("실행됨");
    		$.ajax({
    			url : "/assa/loginVerify.k",
    			type: "POST",
    			data : $("#loginForm").serialize()
        	}).done(function (){
        		var html = $("send_email").html()
/* 			    <label for="send_email" class="col-sm-3 control-label">이메일 인증</label>
			    <div class="col-sm-9">
			      <input class="input form-control" type="text" name="sandEmail" id="send_email" placeholder="  이메일 인증 "/>
			    </div> */
        	});		 	
    	});
