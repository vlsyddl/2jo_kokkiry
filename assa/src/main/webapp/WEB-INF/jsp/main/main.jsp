...
<body>
    ...
    <script>
		...
		$(function () {
			$.ajax({
		 		url: "<c:url value="/main/countBoard.json" />",
		 	})
		 	.done(function (result) {
		 		$(".todayStudy").html(
		 				result.todayStudy
			...
			$(function () {
				$.ajax({
					url: "<c:url value="/main/miniCheckedTodo.json" />",
				})
				.done(function (result) {
					var html ="";
			...
			$(function () {
				$.ajax({
					url: "<c:url value="/main/miniNotCheckedTodo.json" />",
				})
				.done(function (result) {
					var html ="";
					for (var i = 0; i < result.length; i++) {
			...
			$(function () {
				$.ajax({
					url: "<c:url value="/main/chart.json" />",
				})
				.done(function (result) {
					console.log(result);
					var chart1 = document.getElementById("myChart");
