...
public class BoardController {
	...
	@RequestMapping("/insert_recomm.json")
	@ResponseBody
	public int insertRecomm(Recomm recomm){
		return service.insertRecomm(recomm);
	}
	
	@RequestMapping("/delete_recomm.json")
	@ResponseBody
	public int deleteRecomm(Recomm recomm){
		return service.deleteRecomm(recomm);
	}
	
	@RequestMapping("/select_recomm.json")
	@ResponseBody
	public Recomm selectRecomm(Recomm recomm){
		return service.selectRecomm(recomm);
	}
